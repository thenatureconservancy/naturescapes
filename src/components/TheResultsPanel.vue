        ...
        <div class="q-ma-lg">
          ...
          <FilterOption
            :modelValue="{
              ...
              value: 0,
              description:
                'Involvement of a diverse range of stakeholders at various stages of NBS project cycles is fundamental for both the projects success and its legitimacy and acceptance. The inclusion of a diverse stakeholder group in the planning and implementation phases contributes to a more comprehensive approach to problem-solving through NBS, encourages collaboration and knowledge sharing, and enhances the potential for innovative and context-rich solutions. <br>This indicator assesses the diversity of stakeholder groups involved in leading and implementing the project, encompassing municipal, regional, and national governmental bodies, as well as engagement with NGOs and grassroots community groups, universities, and professional networks, and participation from private sector companies and financial institutions.',
            }"
          />
          <FilterOption
            :modelValue="{
              ...
              value: 0,
              description:
                'NBS are commonly framed as integrated solutions to tackling multiple global sustainability challenges. From the early NBS planning stages until NBS implementation, ensuring a coordinated targeting of climate, biodiversity, and social objectives is more likely to generate synergies across these areas of action, avoid trade-offs, and contribute effectively to the promotion of resilient, socially just, and sustainable outcomes. <br>This indicator measures how thoroughly NBS project targets are aligned with the three key priority areas of climate action (adaptation and/or mitigation), biodiversity (conservation and/or mitigation), and social justice (including social cohesion and inclusion). A high-scoring NBS in this context demonstrates a comprehensive targeting effort and a clear commitment to multi-solving across these key priority areas. In contrast, lower scores indicate a more limited focus on some of these key areas, or they may also suggest that the project is intended to focus on other key domains (e.g., economic development, environmental quality, cultural heritage). ',
            }"
          />
        </div>
      </q-expansion-item>
